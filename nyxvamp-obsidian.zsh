...
ZSH_HIGHLIGHT_STYLES[autodirectory]='fg=#8FBF8F,italic'
ZSH_HIGHLIGHT_STYLES[single-hyphen-option]='fg=#F5C2E7'
ZSH_HIGHLIGHT_STYLES[double-hyphen-option]='fg=#F5C2E7'
ZSH_HIGHLIGHT_STYLES[back-quoted-argument]='fg=#A0A0D0'
## Keywords
## Built ins
...
ZSH_HIGHLIGHT_STYLES[named-fd]='fg=#F5C2E7'
...
ZSH_HIGHLIGHT_STYLES[history-expansion]='fg=#A0A0D0'
...
ZSH_HIGHLIGHT_STYLES[arg0]='fg=#A0A0D0'
ZSH_HIGHLIGHT_STYLES[default]='fg=#A0A0D0'
