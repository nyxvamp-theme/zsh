...
ZSH_HIGHLIGHT_STYLES[back-quoted-argument]='fg=#DDB6F2'
## Keywords
## Built ins
...
ZSH_HIGHLIGHT_STYLES[named-fd]='fg=#F8BD96'
ZSH_HIGHLIGHT_STYLES[numeric-fd]='fg=#F8BD96'
## No category relevant in spec
ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#E78284'
ZSH_HIGHLIGHT_STYLES[path]='fg=#D9E0EE,underline'
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#D9E0EE,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#D9E0EE,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix_pathseparator]='fg=#D9E0EE,underline'
ZSH_HIGHLIGHT_STYLES[globbing]='fg=#D9E0EE'
ZSH_HIGHLIGHT_STYLES[history-expansion]='fg=#DDB6F2'
...
ZSH_HIGHLIGHT_STYLES[arg0]='fg=#D9E0EE'
ZSH_HIGHLIGHT_STYLES[default]='fg=#D9E0EE'
